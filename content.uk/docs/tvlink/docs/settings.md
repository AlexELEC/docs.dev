...
Короткий огляд: Smart-режим автоматично визначає оптимальний час оновлення плейлиста, намагаючись отримати новий сегмент якомога раніше при мінімальній кількості запитів. Нижче – повний опис усіх складових і параметрів.
...
Збільшити: Рідше перевіряємо після оновлення — менше запитів, але можна пропустити швидкі зміни.  
Зменшити: Частіше перевіряємо навіть після оновлення.  
Коли: Якщо потік «скачкоподібний» або сервер дуже повільний.  
Рекомендація: 0.7–1.2.

...
Для створення джерела EPG натисніть кнопку «Add EPG» і заповніть форму «Add new EPG».

<p align="center">
  <a href="/tvlink/epg/01.png"><img src="/tvlink/epg/01.png" width="480"/></a>
</p>

+ «EPG name» — це довільна назва на ваш вибір. Вона повинна бути латинськими літерами, без спеціальних символів (пробілів, тире тощо) і не може починатися з цифри.
+ «EPG url» — адреса XMLTV-файлу. Файл може бути заархівованим (у форматі .gz або .tar.gz) або неархівованим (.xmltv). Якщо це локальний файл, адреса повинна починатися з префікса «file://».
...
Синя іконка у стовпці «Name» відображає вікно налаштувань.

<p align="center">
  <a href="/tvlink/epg/03.png"><img src="/tvlink/epg/03.png" width="480"/></a>
</p>

Тут ви можете за необхідності змінити «EPG url», а також модифікувати назви каналів («Modify channel names») використовуючи <a target='_blank' href="https://docs.python.org/3/howto/regex.html">регулярні вирази</a>.

У полі «change from (regular expression)» введіть те, що хочете змінити, а в полі «to» — те, на що хочете змінити.

Регулярний вираз (наведений вище) видаляє префікс "UA:" з назв каналів. Наприклад: було «UA: Сhannel 5», стане «Сhannel 5».

### Кнопки

+ «Create EPG» — створює програму. XMLTV-файл буде доступний за адресою: «http://ip-address:port/xmltv»
+ «Clean auto EPG mapping» — очищає всі зіставлення, які «TVLINK» створив автоматично.
